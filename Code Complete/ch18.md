...
### 索引存取表
索引表是透過一個查詢索引陣列去紀錄查詢表本身的資料。這樣做有兩個好處，第一是索引陣列的欄位大小比查詢表ㄌㄞ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1MDA5Mjk0MzUsLTY4OTkyNzgwNSwxOD
M0NzI0NzkyLDg5MTU4MzcyOCwxMzYwMTk0NjYyLDQ1Nzg4NTEz
OCwxNDIyOTcwMDMwLC04MjEzMzAwNjUsLTExNTM0MTYzNjZdfQ
==
-->